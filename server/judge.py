...
def score_task(task_id: str, output_dir: str, task: Any) -> "ScoreResult":
    """
    Wrapper called by ComtradeEnvironment.submit_results().

    Args:
        task_id:    e.g. "T1_single_page"
        output_dir: base directory; actual files are in output_dir/task_id/
        task:       Task dataclass with .query, .constraints, .fault_injection
    """
    ...
    return score_output(task_dir, task_expected)
